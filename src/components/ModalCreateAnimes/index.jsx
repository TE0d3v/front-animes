...
const ModalCreateAnimes = ({ isOpen, onClose, onSubmit }) => {
  ...
  const validateForm = () => {
    ...
    if (formData.rating !== '') {
      ...
      if (isNaN(rating) || rating < 0 || rating > 10) {
        newErrors.rating = 'A avaliação deve ser um número entre 0 e 10';
      }
    }
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-2xl w-full max-w-md mx-auto border border-gray-700">
        {/* Header do Modal */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent transition-all duration-200 ${
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              rows={3}
              className={`w-full px-4 py-3 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent transition-all duration-200 resize-none ${
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                step="0.1"
                className={`w-full px-4 py-3 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent transition-all duration-200 ${
                  errors.rating ? 'border-red-400' : 'border-gray-600'
                }`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`w-full px-4 py-3 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent transition-all duration-200 ${
                errors.imageUrl ? 'border-red-400' : 'border-gray-600'
              }`}
...
export default ModalCreateAnimes;
